    ...
    <div className="relative h-screen bg-white -z-30">
          ...
          <div className="absolute bottom-0 left-0 w-full bg-white bg-opacity-30">
            ...
            <div className="flex flex-row justify-between pl-3">
              <div>
                ...
                <p className="text-black text-xl">{article.price}</p>
              </div>
              <button className="rounded-full bg-black text-white px-4 my-2 mr-2">
                Acheter
              </button>
            </div>
          </div>
      ...
      <div className="bg-white -mb-4">
        ...
        <div className="mx-2 my-5">
          <button className="rounded-full bg-black text-white p-3 text-center w-full">Acheter</button>
